...
// Creamos un nuevo objeto Facebook con los datos de nuestra aplicaci�n (cambia los datos por los de tu App ID y tu App Secret).
...
// la url de Login o Logout depender� del estado actual del usuario, si est� autentificado o no en nuestra aplicaci�n
// Aqu� obtenemos los permisos del usuario. Por defecto obtenemos una serie de permisos b�sicos
if ($user) {
